...
class pending {
	...
	private function init() {
		...
		*/
		if ( ! $this->labels['label_count'] && $this->labels['display'] !== self::$defaults['display'] ) {
			$this->labels['label_count'] = $this->labels['display'];
		}
		$this->status_labels();
	...
	private function status_labels() {
		...
		if ( ( $lc = $this->labels['label_count'] ) && is_string( $this->labels['label_count'] ) ) {
			global $wp_post_statuses;
			$lc = $this->labels['label_count'];
